...
use Scedel\Codegen\Symfony\Cli\GenerateSymfonyCommand;
...
spl_autoload_register(static function (string $class) use ($workspaceRoot): void {
    $prefixes = [
        ...
        'Scedel\\Codegen\\Symfony\\' => $workspaceRoot . '/scedel-codegen-symfony/src/',
    ];
...
$command = new GenerateSymfonyCommand();
